var size = 0;
var placement = 'point';
function categories_Kubis_5(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                switch(value.toString()) {case 'Dataran Alluvial':
...
var style_Kubis_5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Landform");
    var labelText = "";
    size = 0;
...
var style = categories_Kubis_5(feature, value, size, resolution, labelText,
